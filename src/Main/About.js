      ...
      <div className="desc">
        <div id="mid_left" className="">
          ...
          <p style={{ color: "black" }}>
            ...
            with Blood Donation/Acceptance. We aim at making this website
            reachable enough to anyone who's in need, instantly! GITAM Blood
            Bank is committed on providing the patients with an online portal
            where they can request for blood or take an appointment if
